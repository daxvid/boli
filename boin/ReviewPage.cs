...
public class ReviewPage : ClosePage
{
    ...
    private bool Review()
    {
        ...
        const string hitPath = "./div[3]/div/div[1]/span[2]/div/div[1]/div/span";
        ...
        const string dfPath = "./div[3]/div/div[2]/div[2]/button[2]/span[text()='代付提现']";
    ...
    private bool SetReason(string reason)
    {
        try
        {
            ...
            const string remarkPath = "./div[2]/div/div[2]/div/div[3]/div/div/input[@type='text' and @placeholder='请输入备注']";
            ...
            const string confirmPath = ".//div[@class='ivu-modal-confirm-body']/div[starts-with(text(),'确定修改备注')]/../../" +
    ...
    private bool Reject()
    {
        ...
        const string rejectPath = "./div[3]/div/div[2]/div[2]/button[1]/span[text()='拒绝']";
